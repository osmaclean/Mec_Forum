...
### Descrição
Projeto criado para o desenvolvimento de uma simulação de um blog/social media aplicando o conceito "Mobile First" e para o meu entendimento da funcionalidade "Modal" nos posts.
...
Funcionalidade via JavaScript. Utilizando conceitos como DOM, Eventos, Function Expression, Laços e criado um Mock na folha ``` posts.js ```.
...
[![portfolio](https://img.shields.io/badge/-CLIQUE%20AQUI-yellowgreen)](https://mec-forum.vercel.app)
